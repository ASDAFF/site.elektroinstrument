...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/stati.xml";
$iblockCode = "stati_".WIZARD_SITE_ID;
$iblockType = "content";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/stati_left.php", array("STATI_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/stati_bottom.php", array("STATI_IBLOCK_ID" => $iblockID));
?>